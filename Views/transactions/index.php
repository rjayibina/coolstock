            ...
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    ...
                    <table style="width:100%;font-size:13.5px;border-collapse:collapse;">
                        ...
                        <tr id="vtm-location-row" style="display:none;"><td style="padding:6px 0;color:var(--text-muted);">Location</td><td id="vtm-location" style="padding:6px 0;font-weight:600;"></td></tr>
                    </table>
